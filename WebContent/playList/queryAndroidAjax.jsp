			    ...
			    <div>
				    <table width="50%" border="0" cellspacing="0" cellpadding="0" style="border-color:#FFFFFF;">
				       <tr>
				         ...
				         <td style="border-color:#FFFFFF;" align="left"><img src="<s:text name='sundyn.pic.query' />" width="55" height="25" onclick="playListQueryAjaxAndroid()" class="hand"/></td>
				         <td style="border-color:#FFFFFF;" align="left"><img src="<s:text name='sundyn.pic.add' />" width="63" height="25" onclick="playListAddDialogAndroid()" class="hand"/></td>
				      </tr>
				     </table>
			    </div>
			    <div class="fengge" style="height:25px;">&nbsp;</div>
				  ...
				  <tr>
				   ...
				   <c:forEach items="${pager.pageList}" var="playList">
						<tr>
							...
							<td style="text-align: center;">
								<a href="javascript:playListEditDialogAndroid(${playList.playListId});"><s:text name='sundyn.playList.editTitle' /></a><s:text name="sundyn.separator"/>
								<a href="#" onclick="javascript:playListDelAndroid(${playList.playListId});"><s:text name='sundyn.del' /></a><s:text name="sundyn.separator"/>
								<a href="javascript:playListUpdateDialogAndroid(${playList.playListId});"><s:text name='sudnyn.playList.updateM7' /></a><s:text name="sundyn.separator"/>
<%--								<a href="javascript:playListConfigDialog(${playList.playListId});"><s:text name='sudnyn.playList.editConfigFile' /></a>--%>
								...
								<a href="javascript:playListConfigDialogAndroid(${playList.playListId});"><s:text name="sudnyn.playList.editConfigFile"></s:text></a>
							</td>
						</tr>
					</c:forEach>
				</table>

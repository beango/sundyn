...
<div class="loginbody" id="loginbody">
    ...
    <div class="loginbox">
        <form method="post" id="v" action="managerLogin.action" class="form-condensed">
            <ul>
                <li><label style="font-size:13pt;color:#fff;font-weight:bold;width:100px; display:inline-block;"><s:text name="login.userName" /></label><input  name="managerVo.name" id="name" type="text" class="loginuser" value="" onclick="JavaScript:this.value=''"/></li>
                <li><label style="font-size:13pt;color:#fff;font-weight:bold;width:100px;display:inline-block"><s:text name="login.password" /></label><input name="password1" id="password1" type="password" class="loginpwd" value="" onclick="JavaScript:this.value=''"/></li>
                <li style="padding-left:75px;">
                    <input name="" type="button" class="loginbtn" value="<s:text name="login.login" />" onclick="doclick()"/>
                    <a href="registerView.action" style="color:white;font-size: 12pt;">注册</a>

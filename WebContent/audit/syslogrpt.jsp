...
<script type="text/javascript">
    function query(){
        window.location.href = "syslogrpt.action?startDate="+$("#startDate").val() + "&endDate=" + $("#endDate").val();
    }
</script>
<div class="place">
    ...
    <div>
        ...
        <table class="tablelist" lay-filter="tbl" id="demo">
            ...
            <tr>
                ...
                <th>
                    <s:text name="syslogrpt.column.action"/>
                </th>
                <th>
                    <s:text name="syslogrpt.column.times"/>
                </th>
            </tr>
            </thead>
            <tbody>

...
#year,#month {
	...
	<body> 
		s<script type="text/javascript" src="js/calendar_<s:text name='sundyn.language.calendar' />.js"></script>
		<div id="man_zone">
			<div class="fengge">&nbsp;</div>
			<div class="center_04">
			     <div class="center_04_left">
				      <div><img src="images/04_01_03.jpg" /></div>
				 ...
				 <div class="center_04_right">
				      <div class="title360A"><h3>请输入要查询的员工姓名</h3></div>
					  ...
					  <form id="form1" name="form1" method="post" action="">
					       <table width="80%" height="97" border="0" cellpadding="0" cellspacing="0" style="border-color:#FFFFFF;">
							  <tr>
							    <td width="32%" align="right" style="border-color:#FFFFFF;">请输入员工：</td>
					  ...
					  <div class="fengge">&nbsp;</div>
					  <div class="title360A"><h3>请输入要查询的结果</h3></div>
					  ...
					  <div class="center_04_right_03">
					    <table width="60%" border="0" cellspacing="0" cellpadding="0" style="border-color:#d6ecf8">
			              <tr>
			                <td width="40%" align="right" style="border-color:#d6ecf8" colspan="3"><img src="images/04_05_12.jpg" width="81" height="25" style="cursor: pointer;" onclick="threeQueryDeal()" class="hand" /></td>
			              </tr>
			            </table>
			   		 </div>
				 </div>

...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script>
 		...
 		<div id="man_zone">
 		  ...
 		  <img src="<s:text name='sundyn.guide.pic.top2'/>" />
 		  <div class="guide_start2"></div>
 		  <div class="fengge" style="height:10px;">&nbsp;</div>
 		  <div class="guide_simpleOne">
 		  	  <div>
 		  	  			<input type="hidden" id="id" name="id" value="${m.id}"  />
 		      	 <s:text name='sundyn.guide.datingName'/><input type="text" class="input_comm" name="name" id="name" value="${m.Name}" />
 		      	 <s:text name='sundyn.guide.demoInfo'/><input type="text" class="input_comm" name="remark" id="remark" value="${m.id}" />
 		      </div>
 		  </div>
 		  <div class="guide_start6" style="height:144px;">
 		    	<s:text name='sundyn.guide.info2'/>
   		  </div>
 		  <div class="fengge" style="height:20px;">&nbsp;</div>
  		  <div class="guide_bottom">
 		     ...
 		     <img src="<s:text name='sundyn.guide.pic.next' />" onclick="guideSimpleThree()" />

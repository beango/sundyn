	...
	<body>
		<div id="man_zone">
		  <div class="fengge">&nbsp;</div>
			<div style="width:640px;"><img src="<s:text name='sundyn.role.pic.title' />" /></div>
			    ...
			    <div>
				    <table width="50%" border="0" cellspacing="0" cellpadding="0" style="border-color:#FFFFFF;">
				       <tr>
				         ...
				         <td style="border-color:#FFFFFF;" align="left"><img src="<s:text name='sundyn.pic.query' />" width="55" height="25" onclick="powerQueryAjax()" class="hand"/></td>

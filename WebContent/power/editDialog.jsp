...
<div class="dialog">
	<div class="title">
		<div class="text">
			<s:text name='sundyn.role.editRole' />
		</div>
		<div class="close">
				...
				<table width="100%" height="173" border="0" cellpadding="0"
					...
					<tr>
						...
						<td width="68%" align="left" style="border-color: #e9f5fd;">
							...
							<input name="name" id="name"   value="${m.name}" onchange="powerExist()" /><span id="tip" style="font-size: 12px;color: red;"></span>
						</td>
					</tr>
					<tr>
						...
						<td align="left" style="border-color: #e9f5fd;">
							<input type="checkbox" name="baseSet" id="baseSet" <c:if test="${m.baseSet==true}">  checked="checked"  </c:if> />
						</td>
					</tr>
					<tr>
						<td style="border-color: #e9f5fd;" align="right">
						...
						<td align="left" style="border-color: #e9f5fd;">
							 <input type="checkbox" name="dataManage" id="dataManage" <c:if test="${m.dataManage==true}">  checked="checked"  </c:if> />
						</td>
					</tr>
					<tr>
						<td style="border-color: #e9f5fd;" align="right">
							 ...
							 <select name="deptId" id="deptId">
								<c:forEach items="${list}" var="dept" varStatus="index">
									<option value="${dept.id}"
										<c:if test="${dept.id==m.deptIdGroup}">selected="selected"</c:if>>

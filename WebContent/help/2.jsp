	...
	<script>
 		...
 		<div id="man_zone">
 		  <div style="margin-left: 10px;width: 90%;text-align: left;">
 			...
 			2、单击"员工管理"<br/><img src="images/help6.gif" /><br />
 			3、在"请选择机构"里选中大厅(倒数第二级)<br/><img src="images/help7.gif" /><br />
 			4、单击“添加员工”，弹出“添加员工”对话框<br/><img src="images/help8.gif" /><br />
 			5、输入员工信息信息(用户名不能重复)<br/><img src="images/help9.gif" /><br />
 			6、单击“确定”按钮，添加员工完毕. <br/>
 		  </div>
 	   </div>

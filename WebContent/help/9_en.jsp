	...
	<script>
 		...
 		<div id="man_zone">
 		  <div style="margin-left: 10px;width: 90%;text-align: left;">
		    ...
		    2.click "staff online" button<br/> <img src="images/helpen91.gif"  /> <br/>
		    3.current people on-line<br/><img src="images/helpen92.gif"  /><br/>
		    4."staff online"  can  exam staff state . 
 		  </div>
 	   </div>

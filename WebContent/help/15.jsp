	...
	<script>
 		...
 		<div id="man_zone">
 		  ...
 		  <div class="guide">
 		     <div class="tip">
 		        <h1>配置向导</h1>
 		        <h2>添加完机构信息后，添加员工信息.</h2>
 		        <h3>1、单击系统管理</h3>
 		        <h3>2、单击"员工管理"</h3>
 		        <h3>3、单击大厅，添加员工信息,"用户名不能重复"</h3>
 		        <input type="checkbox" id="istip" onclick="deptGuideSave()"/>下次不再提示<br/>
 		        <img src="images/guide_employee.gif" onclick="employeeGuide()"/>
 		     </div>
 		  </div>
  	   </div>

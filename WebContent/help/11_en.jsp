 		...
 		<div id="man_zone">
 		  <div style="margin-left: 10px;width: 90%;text-align: left;">
		    ...
		    <img src="images/helpen11.gif"  /><br/>
 			2.click "Resources Manager"  button  <br/><img src="images/helpen111.gif" /><br />
 			3.click "add" button <br/><img src="images/helpen112.gif" /><br />
 			4.enter information,<br/><img src="images/help39.gif" /><br />
 			5.click "ok" button,endding the resouses manager.
 		  </div>
 	   </div>

	...
	<script>
 		...
 		<div id="man_zone">
 		  <div style="margin-left: 10px;width: 90%;text-align: left;">
 		    1、单击"决策分析"<br/><img src="images/help14.gif"  /><br/>
		    2、单击"业务总量走势分析"<br/> <img src="images/help20.gif"  /> <br/>
		    3、单击“周数析分析”按钮<br/><img src="images/help21.gif"  /><br/>
		    4、可以“周数据分析”、“十五天数据分析”、“月数据分析”。<br/>
		    5、最少要有两天的评价数据，才能画出曲线图。<br/>
		    6、其他的分析都是一样的。
 		  </div>
 	   </div>

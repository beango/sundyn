	...
	<script>
 		...
 		<div id="man_zone">
 		  <div style="margin-left: 10px;width:90%;text-align: left;">
		    ...
		    2.click "role manager" button <br/> <img src="images/helpen81.gif"  /> <br/>
		    3.click "Add" button  <br/><img src="images/helpen82.gif"  /><br/>
		    4.poping "adding role" dialog ,enter role information <br/><img src="images/helpen83.gif"  /><br/>
		    5.click  "ok"  button,endding add role.
 		  </div>
 	   </div>

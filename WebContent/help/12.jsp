	...
	<script>
 		...
 		<div id="man_zone">
 		  <div style="margin-left: 10px;width: 90%;text-align: left;">
 			...
 			2、单击"播放列表管理"<br/><img src="images/help40.gif" /><br />
 			3、单击 "添加"按钮，弹出“添加播放列表 ”对话框<br/><img src="images/help41.gif" /><br />
 			4、输入完信息，单击“确定”保存<br/><img src="images/help42.gif" /><br />
 			5、添加完毕。<br/>
 			6、在“修改播放列表”里生成升级包<br/>

				 ...
				 <div class="center_04_right">
					  ...
					  <div class="center_04_right_03">
					    <table width="60%" border="0" cellspacing="0" cellpadding="0" style="border-color:#d6ecf8">
			              <tr>
			                <td width="40%" align="right" style="border-color:#d6ecf8" colspan="3"><img src="<s:text name='sundyn.total.pic.query'/>" width="81" height="25" style="cursor: pointer;" onclick="appriesDelDeal()" class="hand" /></td>
			              </tr>
			            </table>
			   		 </div>
				 </div>

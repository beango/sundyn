        ...
        <div class="nLpostion">
            <div class="wid980">
                <div style="height: 1080px;">
                    ...
                    <div style="width: 400px; position: relative; top: 385px; left: 240px;">
                        <div class="logo_txt"></div>
                        <div class="login_box">
                            <form method="post" id="v" action="managerLogin.action" class="form-condensed">
                                <table class="table table-form">
                                    <tbody><tr>
                                        <th style="font-size:13pt;color:#fff;">用户名</th>
                                        <td><input class="form-control" type="text" name="managerVo.name" id="name" value="admin" style="width:150px;"></td>
                                    </tr>
                                    <tr>
                                        <th style="font-size:13pt;color:#fff;">密码</th>
                                        <td><input class="form-control" type="password" name="password1" id="password1" value="" style="width:150px;">
                                            <input type="hidden" title="密码" name="managerVo.password" id="password" value="" style="width:150px;" />
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <th></th>
                                        <td>
                                            <input type="button" class="btn btn-primary" style="height:40px;width:70px;font-size:13pt;color:#fff;" data-loading="稍候..." value="登 录" onclick="doclick()" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th></th>

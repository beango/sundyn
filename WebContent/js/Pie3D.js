...
this.Text3d="<v:shapetype id='3dtxt' coordsize='21600,21600' o:spt='136' adj='10800' path='m@7,l@8,m@5,21600l@6,21600e'>"+
                    "<v:path textpathok='True' style='font-color:red;' o:connecttype='custom' o:connectlocs='@9,0;@10,10800;@11,21600;@12,10800' o:connectangles='270,180,90,0'/>"+
                    "<v:textpath on='True' fitshape='t'/>"+
...
//图例边框据左边的距离
legendbx.style.left='12500px';
//图例总背景宽度
legendbx.style.width='7000px';
...
legendttl.style.left='12500px';
legendttl.style.width='6000px';
...
legendttl.strokecolor='#000';
    fillStyle="<v:TextBox inset='2pt,0pt,0pt,0pt' style='font-size:10pt;'>"+
                "<div align='left'><font color='#000'>count:"+this.vTotal+"</font></div></v:TextBox>";
...
//鼠标经过饼状图时 图例改变的样式
legendxbg.style.left='12500px';
legendxbg.style.width='6100px';
...
legendxtxt.style.left='14000px';
//图例的现实宽度
legendxtxt.style.width='5000px';
...
cakepie.innerHTML="<v:shape id='cake"+(i+1)+"' type='#Cake_3D' title='"+this.Cakes[i][0]+":"+xRound(this.Cakes[i][1],2)+"比例:"+xRound(this.Percent[i]*100,2)+"%'"+
                            ...
                            "</v:shape>";
cakepie.innerHTML+="<v:shape id='txt"+(i+1)+"' type='#3dtxt' style='position:absolute;left:"+txt_x+"px;top:"+txt_y+"px;z-index:20;display:none;width:50; height:10;'"+
                            " fillcolor='red' onmouseover='ontxt(cake"+(i+1)+","+(_top + Height / 14)+",txt"+(i+1)+",rec"+(i+1)+")'>"+
                            "<v:fill opacity='60293f' color2='fill lighten(120)' o:opacity2='60293f' rotate='t' angle='-135' method='linear sigma' focus='100%' type='gradient'/>"+
                            "<v:textpath on='true' style='font-family:楷体' trim='t' fitpath='t' string='"+this.Cakes[i][0]+":"+xRound(this.Percent[i]*100,2)+"%'/> "+

//语言全局变量开
//var queryEmployeeDealAlert="请先查询,再选择人员"
  var queryEmployeeDealAlert="Please inquiry, and then select the staff";
//var queryEmployeeDealForDelAlert="请先查询,再选择人员"
  var queryEmployeeDealForDelAlert="Please inquiry, and then select the staff";
//var analyseEmployeeAjaxAlert="先查询，选择人员"
  var analyseEmployeeAjaxAlert="Please inquiry, and then select the staff"
//var analyseEmployeeContentAjaxAlert="先查询，选择人员"
  var analyseEmployeeContentAjaxAlert="Please inquiry, and then select the staff"
//var analyseEmployeeContentRateAjaxAlert="先查询，选择人员"
  var analyseEmployeeContentRateAjaxAlert="Please inquiry, and then select the staff";
//var addChildItemAlert1="请选择部门"
  var addChildItemAlert1="plaase choose unit"
//var addChildItemAlert2="请输入机构名称"
  var addChildItemAlert2="please enter unit"
//var delAlert1="不能删除最高机构";
  var delAlert1="don't  delet unit";
//var delAlert2="你确认要删除么？";
  var delAlert2="are you deleting?";
//var deptEditItemAlert="请选择部门"
  var deptEditItemAlert="please choose unit"
//var employeeAddAlert="该用户已存在";
  var employeeAddAlert="is existed";
//var employeeEditAlert="该用户已存在";
  var employeeEditAlert="the use is existed";
//var employeeInAlert1="请先选择左边的部门，再查看流动人员";
  var employeeInAlert1="please select the left of the titles and Examine the free man";
//var employeeInAlert2="已经调入该部门，请点击查看";
  var employeeInAlert2="Has been transferred to this department,please Click to view";
//var employeeResetAlert="密码重置成功"
  var employeeResetAlert="password reset success"
//var saveSuccess="saveing seccess";
  var saveSuccess="saveing seccess";
//var managerCheckAlert1="用户名不能为空";
  var managerCheckAlert1="user name is not null";
//var managerCheckAlert2="真实姓名不能为空"
  var managerCheckAlert2="real name is not null"
//var managerAddAlert="该用户已经存在"
  var managerAddAlert="the user is existed";
//var  managerEditAlert="该用户已经存在"
  var  managerEditAlert="this user is existed "
//var managerDelAlert="不能删除此超级用户"
  var managerDelAlert="con't delte this user"
//var managerResetAlert="密码重置换成功，为初始密码"
  var managerResetAlert="password reset success,this value is original"
//var powerAddAlert1="用户名不能为空"
  var powerAddAlert1="the user name is not null"
//var powerAddAlert2="该角色名存在"
  var powerAddAlert2="the role is existed";
//var powerEditalert1="用户名不能为空"
var powerEditalert1="the user name is not null!"
//var powerEditalert2="该角色名存在"
  var powerEditalert2="the role is existed"
//var playAddAlert="序列只能为数字"
  var playAddAlert="the serial  must only number"
//var playEditAlert="序列只能为数字"
  var playEditAlert="the serial must only number"
//var playListCreateUpdateFileAlert="生成成功"
  var playListCreateUpdateFileAlert="created success!"
//var playListUpdateDealAlert1="请上传文件";
  var playListUpdateDealAlert1="please upload file";
//var playListUpdateDealAlert2="必须上传ZIP文件";
  var playListUpdateDealAlert2="must only upload  type of zip file";
//var quicklyAddAlert1="请输入快速查询名"
  var quicklyAddAlert1="please enter quckly inquiry name"
//var quicklyAddAlert2="添加成功"
  var quicklyAddAlert2="adding success"
//var managerQxAlert="你没有权限访问此功能"
  var managerQxAlert="you don't have this power";
//var htmltoexcelAlert="导出失败,请确认你安装了excel，并设置ie安全级别为底"
  var htmltoexcelAlert="export error,please set IE safe"
//var starDelAlert="最少要两个";
  var starDelAlert="at least two";
//var starAddAlert1="最多10个"
  var starAddAlert1="at most ten"
var starAddAlert2="<b>satisfied rate:</b><input type='text'   class='input_comm' name='prate' /><b>above</b><input type='text'    class='input_comm' name='pgrade'/><b>mark</b><input type='text'   class='input_comm' name='pstar' /><b>level</b>  <img src='images/tp_add.gif'  onclick='starAdd()'/> <img src='images/tp_del.gif' onclick='starDel(this)' />"
//var sundynSetSaveAlert="下面的数据，只能小于等于上面的数据";
var sundynSetSaveAlert="down data must less-than up data";
//var voteAddAlert1="投票标题不能为空"
  var voteAddAlert1="the vote title is not null"
//var voteAddAlert2="投票选项不能为空"
  var voteAddAlert2="the selection is not null"
//var voteSelectDelAlert="最少要两个"
  var voteSelectDelAlert="at least two"
//var voteSelectAddAlert="最多十个选项"
  var voteSelectAddAlert="at most ten"
var voteSelectAdd_li=" 	selection:<input type='text' name='voteSelect'   /><img src='images/tp_add.gif' onclick='voteSelectAdd()' /><img src='images/tp_del.gif' onclick='voteSelectDel(this)' />"
//var businessAddAlert="问卷标题不能为空";
  var businessAddAlert="title is not null";
//var businessDelAlert="不允许删除根节点"
  var businessDelAlert="don't  allow delete"
//var businessImportAlert="请选择导入文件";
  var businessImportAlert="please choose import file";
//var businessImport_loadSuccess="导入成功"
var businessImport_loadSuccess="load success"
//var businessWjDealAlert="调查数据不能为空"
  var businessWjDealAlert="vote data is not null"

//var onlyNumAlert="只能输入1,2,3,4,5,单个数字";
  var onlyNumAlert="only enter 1,2,3,4,5   ,simple number";
//var baseBackUPAlert1="是否备份数据"
  var baseBackUPAlert1="do you backup date?"
//var baseBackUPAlert2="备份成功"
  var baseBackUPAlert2="backup success";
//var baseRestoreAlert1="是否还原数据"
  var baseRestoreAlert1="do you restore data?"
//var baseRestoreAlert2="还原成功"
  var baseRestoreAlert2="restor success"
//var baseDelRestoreAlert="是否删除"
  var baseDelRestoreAlert="do you delete?"
//var isNumberAlert="不是数字，请从新输入"
  var isNumberAlert="not number,please enter again"
//var isIPAlert="不是合法IP，请从新输入";
  var isIPAlert="not IP,please enter again";
//var isUrlAlert="不是合法升级地址，请从新输入"
  var isUrlAlert="not update url,please enter again"
//var getMacAlert="创建Active对象失败,请设置IE"
  var getMacAlert="create Active object fail,please set IE"
//var clientTypeChange_enter="请手工输入设备号 "
  var clientTypeChange_enter="please enter device number"
//var productTypeChange_enter="(手工输入设备号) "
  var productTypeChange_enter="(please enter device number) "
//var quideSaveOrUpdateAlert1="窗口名称不能为空"
  var quideSaveOrUpdateAlert1="window name is not null"
//var quideSaveOrUpdateAlert2="设备信息不能为空"
  var quideSaveOrUpdateAlert2="device information is not null"
//var quideSaveOrUpdateAlert3="设备信息不合法，请输入从新输入"
  var quideSaveOrUpdateAlert3="device information illegaled,please enter again"
//var guideSimpleEmployeeSaveOrUpdateAlert1="请输入员工姓名"
  var guideSimpleEmployeeSaveOrUpdateAlert1="please enter staff name"
//var guideSimpleEmployeeSaveOrUpdateAlert2="请输入员工卡号"
  var guideSimpleEmployeeSaveOrUpdateAlert2="please enter  card num"
//var guideMultiDeptAddAlert1="窗口名称不能为空"
  var guideMultiDeptAddAlert1="window name is not null"
//var guideMultiDeptAddAlert2="设备信息不能为空"
  var guideMultiDeptAddAlert2="device information is not null"
//var guideMultiDeptAddAlert3="设备信息不合法，请输入从新输入"
  var guideMultiDeptAddAlert3="device information illegaled,please enter again"
//var guideMultiSelectAlert1="请添加窗口"
  var guideMultiSelectAlert1="pleae adding window "
//var guideMultiSelectAlert2="请添加大厅"
  var guideMultiSelectAlert2="please adding hall"
//var guideMultiSelectAlert3="请添加机构"
var guideMultiSelectAlert3="please adding unit"
//var threeLoadAlert="请选择上传文件"
  var threeLoadAlert="please upload file"
// var  inputEmployeeNum="请先输入工号,再查询人员"  
   var  inputEmployeeNum=""
//语言全局变量 结束
...
function deleteVideoFileDeal() {
	...
	var startDate = getStartDate();  
	var endDate =  getEndDate();
	window.location.href = "deleteVideoFileDeal.action?deptId=" + deptId + "&startDate=" + startDate + "&endDate=" + endDate;
}
//查看mac是否重复
...
function queryEmployeeDealForDel() {
	var id = document.getElementById("id").value;
	if(id==""){
		alert(queryEmployeeDealForDelAlert);
		return false;;
	}
	var startDate = document.getElementById("startDate").value;
	var endDate = document.getElementById("endDate").value;
...
function analyseEmployeeAjax() {
	...
	var employeeId = document.getElementById("id").value;
	if(employeeId == ""){
	  alert(analyseEmployeeAjaxAlert);
	 return false;
	}
...
function addChildItem() {
	if (document.getElementById("deptId").value == "") {
		alert(addChildItemAlert1);
		return false;
	}
	if (document.getElementById("deptName").value == "") {
		alert(addChildItemAlert2);
		return false;
	}
...
//	alert("product_type="+product_type);
	dojo.xhrPost({url:"deptAddChildItem.action", content:{deptId:deptId, deptName:deptName, reMark:reMark, client_type:client_type, product_type:product_type, deptType:deptType,dept_camera_url:dept_camera_url,dept_businessId:dept_businessId,dept_playListId:dept_playListId,deptPause:deptPause,deptPic:deptPic,deptLogoPic:deptLogoPic,useVideo:useVideo,notice:notice}, load:function (resp, ioArgs) {
...
function del() {
	...
	dojo.xhrPost({url:"deptDel.action", content:{deptId:deptId}, load:function (resp, ioArgs) {
		...
		document.getElementById("tree").innerHTML = d;
		//清除deptid
		document.getElementById("deptView").innerHTML = "<h3>unit manager</h3><div class='sundyn_row'>please first choose left organizition,and take relevant opening.   </div>";
	}});
}
//添加机构对话框
...
function employeeAdd() {
	if(document.getElementById("tip").innerHTML==employeeAddAlert){
		alert(employeeAddAlert);
		return false;
	}
...
function employeeEdit() {
	if(document.getElementById("tip").innerHTML==employeeEditAlert){
		alert(employeeEditAlert);
		return false;
	}
...
function managerCheck(){
	var name = document.getElementById("name").value;
	if(name==""){
		alert(managerCheckAlert1);
		return false;
	}
	var realname = document.getElementById("realname").value;
	if(realname==""){
		alert(managerCheckAlert2);
		return false;
	}
	return true;
}
...
//添加用户
function managerAdd() {
	if(document.getElementById("tip").innerHTML==managerAddAlert){
		alert(managerAddAlert);
		return false;
	}
...
function managerEdit() {
	if(document.getElementById("tip").innerHTML==managerEditAlert){
		alert(managerEditAlert);
		return false;
	}
	var check=managerCheck();
	if(!check){
...
function powerAdd() {
	var name = document.getElementById("name").value;
	if(name==""){
		alert(powerAddAlert1);
		return false;
	}
	if (document.getElementById("tip").innerHTML==powerAddAlert2) {
		alert(powerAddAlert2);
		return false;
	}  
...
function powerEditDialog(data) {
 ...
 function powerEdit() {
	...
	var name = document.getElementById("name").value;
	if(name==""){
		alert(powerEditalert1);
		return false;
	}
	if (document.getElementById("tip").innerHTML==powerEditalert2) {
		alert(powerEditalert2);
		return false;
	}
	var baseSet = document.getElementById("baseSet");
	if (baseSet.checked) {
...
//	var playContent=FCKeditorAPI.GetInstance("playContent").GetXHTML(true); 
	var playContent = document.getElementById("playContent").value;
 	var patrn=/^[0-9]{1,20}$/;
	if (!patrn.exec(playIndex)){alert(playAddAlert);document.getElementById("playIndex").focus();return false;}
...
//	var playContent=FCKeditorAPI.GetInstance("playContent").GetXHTML(true); 
	var playContent = document.getElementById("playContent").value;
	var patrn=/^[0-9]{1,20}$/;
	if (!patrn.exec(playIndex)){alert(playEditAlert);document.getElementById("playIndex").focus();return false;}
...
function playListCreateUpdateFile(data){
	document.getElementById("pbar").src="images/update_processbar_en.gif";
	var playIds = getAllKey();
	dojo.xhrPost({url:"playListCreateUpdateFile.action", content:{playListId:data,playIds:playIds}, load:function (resp, ioArgs) {
		 document.getElementById("pbar").src="images/update_processend_en.gif";
		 alert(playListCreateUpdateFileAlert);
	}});
}
//生成在线升级包,Zip格式
function playListCreateUpdateZip(data){
	...
	dojo.xhrPost({url:"playListCreateUpdateZip.action", content:{playListId:data,playIds:playIds}, load:function (resp, ioArgs) {
		document.getElementById("pbar").src="images/update_processend_en.gif";
		alert("Generate Zip package success!");
	}});
}
...
function playListCreateUpdateZipFile(data){
	...
	dojo.xhrPost({url:"playListCreateUpdateZip.action", content:{playListId:data,playIds:playIds}, load:function (resp, ioArgs) {
		document.getElementById("pbar").src="images/update_processend_en.gif";
		alert("Generate Zip and Bin package success!");
//		alert("Zip生成成功");
	}});
}
...
function htmltoexcel(tableid) {//整个表格拷贝到EXCEL中 
 ...
 function  printHTML(path,Data)   
  {   
      ...
      f.Write(html);   
      f.Close();
      window.showModalDialog('c:\\print.htm','Print',"resizable=no;help=no;center:yes;scroll=no;status=yes;dialogHeight=768px;dialogWidth=1024px");
	...
	dojo.io.iframe.send({url:"baseUploadTempDeal.action", method:"post", handleAs:"text", form:dojo.byId("temp"), handle:function (data, ioArgs) {
 		if (data != "") {
  			var info=data.parseJSON();
  			 ...
  			 temp.innerHTML =temp.innerHTML + ""+info.tempName+"<input type='button' value='Preview' onclick='basePreviewTemp(this,\""+info.tempUrl+"\")' />    <input type='button' value='Delete' onclick='baseDelTemp(this)' />";
...
// alert(coun);
	if(coun>4){
		alert('you can choose four options at most');
		return ;
	}
	//得到系统设置
...
function voteAdd(){
  ...
  if(voteTitle==""){alert(voteAddAlert1);document.getElementById("voteTitle").focus(); return 0;}
...
//投票取消
function voteCancel(){
  ans=window.confirm('do you cancel vote?');
 //alert (ans);                      
 if (ans==true)
  {
  document.getElementById("voteTitle").value="";
...
function voteSelectAdd(){
	 ...
	 if(voteSelect.childNodes.length>9){
	  alert(voteSelectAddAlert);
	  return 0;
	 }
 	 var select=document.createElement("li");
	 select.innerHTML =voteSelectAdd_li  
...
function delAppraise(){
  if (window.confirm("are you sure deleteing  ")){
	  var tempIds="";
...
function appraiseDelAll(data){
    if (window.confirm("are you sure deleteing all data")){
...
function isNumber(oNum){
  var strP=/^\d+(\.\d+)?$/; 
  if(!strP.test(oNum))alert(isNumberAlert); 
}
function keyIsNumber(data){
  var strP=/^\d+(\.\d+)?$/; 
  if(!strP.test(data.value)){alert(isNumberAlert);data.value="";} 
}
 function   isIP(str){   
  var   ip   =   /^([1-9]|[1-9]\d|1\d{2}|2[0-1]\d|22[0-3])(\.(\d|[1-9]\d|1\d{2}|2[0-4]\d|25[0-5])){3}$/;   
  if(!ip.test(str))alert(isIPAlert); 
  } 
function isUrl(str_url){ 
   var strRegex = "^((https|http|ftp|rtsp|mms)?://)"
        ...
        if(! re.test(str_url)){alert(isUrlAlert)}
}
...
function clientTypeChange(data){
  if(data == 1){
     ...
     document.getElementById("tip").innerHTML=clientTypeChange_enter
  }else{
...
function productTypeChange(data){
  if(data < 0){
     document.getElementById("tip").innerHTML="(<a href=\"#\" onclick=\"getMac()\" >Get MAC address automatically</a>) "
  }else{
     document.getElementById("tip").innerHTML=productTypeChange_enter
  }
}
//向导功能
...
function quideSaveOrUpdate(){
  if(document.getElementById("name").value==""){
     alert(quideSaveOrUpdateAlert1);
     document.getElementById("name").focus;
  	 return  false;
  }
  if(document.getElementById("remark").value==""){
     alert(quideSaveOrUpdateAlert2);
...
function guideSimpleEmployeeSaveOrUpdate(){
	...
	if(document.getElementById("name").value== ""){
	  alert(guideSimpleEmployeeSaveOrUpdateAlert1);
	  document.getElementById("name").focus();
	  return false;
	}
	if(document.getElementById("cardnum").value== ""){
	  alert(guideSimpleEmployeeSaveOrUpdateAlert2);
...
function guideMultiDeptAdd(){
 if(document.getElementById("name").value==""){
     alert(guideMultiDeptAddAlert1);
     document.getElementById("name").focus;
  	 return  false;
  }
  if(document.getElementById("remark")!=null){
	  if(document.getElementById("remark").value==""){
	     alert(guideMultiDeptAddAlert2);
	     document.getElementById("remark").focus;
	  	 return  false;
	  }
	  if((document.getElementById("remark").value>=0 && document.getElementById("remark").value<=255) || document.getElementById("remark").value.length== 12   ){
...
function guideMultiSelect(){
	...
	if(li.length==0){
	  if(deptType==0){
	    alert(guideMultiSelectAlert1);  
	  }else if(deptType==1){
	    alert(guideMultiSelectAlert2);
	  }else if(deptType==2){
	    alert(guideMultiSelectAlert3);
	  }
	 return 0;
	}
...
function guideDeptTypeAjax(data){
 ...
 function topImg(){
 	      ...
 	      if(deptType==2){
 	      	topimg.src="images/guide_top1_en.gif"
 	      }else if (deptType==1){
 	      	topimg.src="images/guide_top2_en.gif"
 	      }else if (deptType==0){
 	      	topimg.src="images/guide_top3_en.gif"
 	      }else{
 	      	topimg.src="images/guide_top4_en.gif"
 	      }
}
...
//	alert("employeeId="+employeeId+"num="+num+"startDate="+startDate+"amUp"+amUp+"key="+key);
	document.location.href = "autoDeal2?employeeId=" + employeeId +"&deptId="+deptId+ "&startDate=" + startDate + "&endDate=" + endDate + "&deptIds=" + deptIds + "&key=" + key+ "&amUp=" + amUp+ "&amDown=" + amDown+ "&pmUp=" + pmUp+"&pmDown=" + pmDown+"&num="+num;
}
...
//alert(data);
	dojo.xhrGet({url:"checkMacBinding.action", content:{mac:data}, load:function (resp, ioArgs) {
		if(resp.trim().length > 0){
//alert(resp);
	     	if(resp.trim()=="mac Is already in use"){
	     		document.getElementById("tip").innerHTML=resp.trim();
	     		alert('mac has been used');
	     	}else{
	     		document.getElementById("tip").innerHTML="mac is ok";
	     	}
	     }
	}});
}
...
function addInput(){
	 var inputText=document.getElementById("addInput");
 	 var inp=document.createElement("<li style='width:400px'>");
 	 inp.innerHTML ="<input style='width:300px' type='text' name='as' value='' /> <img src='images/tp_del.gif' onclick='delInput(this)' /></li>"

...
<html>
	...
	<body>
                 ...
                 &nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;
				 <a href="update/client.exe"><s:text name="login.commClient" /></a> <s:text name="login.commClient.info" />
				 <a href="update/M7.exe"><s:text name="login.m7Client" /></a><s:text name="login.m7Client.info" />

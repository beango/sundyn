...
#year,#month {
	...
	<body>
		...
		<div id="man_zone">
			...
			<div class="title360"> <h3>按照业务统计</h3></div>
				...
				<form id="form1" name="form1" method="post" action="">
				     <table width="75%" height="150" border="0" cellpadding="0" cellspacing="0" style="border-color:#FFFFFF;">
						  ...
						  <tr>
						    ...
						    <td align="left" valign="bottom" style="border-color:#FFFFFF;"><img src="images/02_02_07.jpg" alt="查询" width="80" height="25" onclick="totalBusinessDeal()" style="cursor: pointer;" /></td>
						  </tr>
					</table>
		       </form>
			</div>

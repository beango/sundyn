	...
	<body>
		<div id="man_zone">
			<div class="sundyn_main">
				...
				<div class="sundyn_row">
					<a href="totalWindowExcel.action?startDate=${startDate}&endDate=${endDate}&deptId=${deptId}">导出excel</a>
					<a href="totalWindowPrint.action?startDate=${startDate}&endDate=${endDate}&deptId=${deptId}" target="_blank">打印</a>
				</div>
				<div class="sundyn_row">
				    ${pager.pageTextCn }
				</div>
...
<script language="javascript">
 	if(isIe()){
			...
			var pie=new Pie3D('PieDiv',320,192,'机构统计');

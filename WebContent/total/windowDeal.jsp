 			...
 			<div style="width:732px;margin:0 auto;">
				<table width="100%"  cellpadding="0" cellspacing="0"  >
				  <tr>
				    ...
				    <td colspan="${fn:length(bmls)+1}" align="center" valign="middle" background="images/table_bg_03.jpg" class="px13_2"><s:text name="sundyn.column.nocontent"/></td>
				    <td width="7%" rowspan="2" align="center" valign="middle" background="images/03_02_07.jpg" class="px13_1"><s:text name="sundyn.column.noappries"/></td>
				    <c:if test="${k7 == true}">
...
<%--				    <td width="5%" height="47" align="center" valign="middle" bgcolor="fef9f3"  class="px13_1">${key.name}</td>--%>
			...
			<div class="fengge"></div>
            <div>
				<s:if test="list.size==0"><a href="javascript:noData('this');"></s:if><s:else>  <a href="totalWindowExcel.action?startDate=${startDate}&endDate=${endDate}&deptId=${deptId}" target="_blank"></s:else>
                
            <img src="<s:text name='sundyn.total.pic.excel'/>" /></a>&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="totalWindowPrint.action?startDate=${startDate}&endDate=${endDate}&deptId=${deptId}" target="_blank">
            <img src="<s:text name='sundyn.total.pic.print'/>" /></a>&nbsp;&nbsp;&nbsp;&nbsp;
            <!-- 窗口满意度对比图显示 -->
           
            <a href="windowDuiBiAction.action?startDate=${startDate}&endDate=${endDate}&deptId=${deptId}" target="_self">
            <img src="<s:text name='sundyn.total.jigou.duibi'/>" /></a>
            <!-- 查看视频,我要查询 -->
            <!--
            &nbsp;&nbsp;&nbsp;&nbsp;
            <a href="videoList.action"><img src="<s:text name='sundyn.total.pic.query'/>"</a>
            -->
            </div>

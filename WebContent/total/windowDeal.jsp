...
<div class="layui-form">
    ...
    <div class="layui-inline">
        <div class="layui-input-inline">
            <div style="float: left; height: 25px; margin-left:10px; border-color:#FFFFFF;" onclick="totalWindowDeal(false)">
            ...
            <div style="float:left; margin-left:10px; ">
                ...
                <a href="javascript:noData('this');">
                    ...
                    <s:else>
                    <a href="#" onclick="totalWindowDeal(true, '<%=request.getParameter("sort")%>')">
                        </s:else>

...
<%--			<script type="text/javascript" src="js/calendar_een.js"></script>--%>
		...
		<div id="man_zone">
			...
			<div class="title360"> <h3><s:text name='sundyn.total.title4'/></h3></div>
				...
				<form id="form1" name="form1" method="post" action="">
				     <table width="75%" height="150" border="0" cellpadding="0" cellspacing="0" style="border-color:#FFFFFF;">
						  ...
						  <tr>
						    ...
						    <td align="left" valign="bottom" style="border-color:#FFFFFF;"><img src="<s:text name='sundyn.total.pic.query'/>"   width="80" height="25" onclick="totalPersonDeal()" style="cursor: pointer;" /></td>
						  </tr>
					</table>
		       </form>
			</div>

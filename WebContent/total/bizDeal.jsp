...
<div class="layui-form">
    ...
    <div class="layui-select-cus layui-inline">
        <label class="layui-form-label" style="width:100px;">请选择大厅：</label>
        ...
        <div class="layui-input-inline">
            ...
            <div style="float:left; margin-left:10px; ">
                <s:if test="list.size==0">
                    ...
                    <s:else>
                        <a href="#" onclick="totalBizDeal(true, '<%=request.getParameter("sort")%>')">
                            </s:else><img src="<s:text name='sundyn.total.pic.excel'/>" /></a>
            </div>
        </div>
    </div>
       ...
       <tr>
           ...
           <td rowspan="2" align="center" valign="middle"
               background="images/03_02_07.jpg" class="px13_1"><s:text
                   name="sundyn.column.datingName"/></td>
           <td rowspan="2" align="center" valign="middle"
               background="images/03_02_07.jpg" class="px13_1">业务名称</td>
           ...
           <%--<td rowspan="2" align="center" valign="middle" background="images/03_02_07.jpg"
               class="px13_1" sort="pausetime">暂停时长<img src="../images/nor.png" /></td>--%>
       ...
       <tr>
           <c:forEach items="${mls}" var="key">
               <s:if test='getText("sundyn.language") eq "en"'>
                   <td align="center" valign="middle"
                       bgcolor="fef9f3" class="px13_1" style="line-height: 30px;">${key.ext2}</td>
               </s:if>
               <s:else>
        ...
        <c:forEach items="${list}" var="total" varStatus="status">
            <tr>
                ...
                <td align="center" valign="middle">${total.deptname}</td>
                <td align="center" valign="middle" style="word-wrap: break-word;"><span title="${total.bizname}">${total.bizname}</span></td>
                ...
                <%--<td align="center" valign="middle">${total.pausetime==null?"":total.pausetime.replace("0天00时00分","").replace("0天00时","").replace("0天","")}</td>--%>
        ...
        <table id="table1" width="100%" height="172" border="0"
            ...
            <c:forEach items="${mls}" var="key" varStatus="index">
                <tr>
                    ...
                    <td width="28%" align="left" valign="middle">
                        <div
                                style="height:10px; width:${totalMap.keyr[key.keyNo]}%; background-color:#FF0000;">
                            &nbsp;
                        </div>
                    </td>
            ...
            <c:if test="${k7 == true}">
                <tr>
                    ...
                    <td width="28%" align="left" valign="middle">
                        <div
                                style="height:10px; width:${totalMap.kr6}%; background-color:#FF0000;">&nbsp;
                        </div>
                    </td>

...
#year,#month {
	...
	<body>
		...
		<div id="man_zone">
			...
			<div class="title360"> <h3>满意度统计</h3></div>
				...
				<form id="form1" name="form1" method="post" action="">
				     <table width="75%" height="150" border="0" cellpadding="0" cellspacing="0" style="border-color:#FFFFFF;">
 						  <tr>
						    ...
						    <td align="left" style="border-color:#FFFFFF;"><input type="text" id="startDate" <s:text name="sundyn.language.calendar.setDay"/> /></td>
						  </tr>
						  <tr>
						    <td align="right" style="border-color:#FFFFFF;">结束时间：</td>
						    <td align="left" style="border-color:#FFFFFF;"><input type="text" id="endDate"	<s:text name="sundyn.language.calendar.setDay"/> /></td>
						  </tr>
						  <tr>
						    <td align="right" style="border-color:#FFFFFF;">请选择大厅:</td>
						    <td align="left" style="border-color:#FFFFFF;">
						      <select id="businessId" name="businessId">
								<c:forEach items="${list}" var="business" varStatus="index">
									<option <c:if test="${index.index==0}">  selected="selected" </c:if> value="${business.businessId}">
 										${fn:substring(business.businessName,0,10)}
									</option>
								</c:forEach>
							  </select>
						    </td>
						  ...
						  <tr>
						    ...
						    <td align="left" valign="bottom" style="border-color:#FFFFFF;"><img src="images/02_02_07.jpg" alt="查询" width="80" height="25" onclick="totalDDeal()" style="cursor: pointer;" /></td>
						  </tr>
					</table>
		       </form>
			</div>

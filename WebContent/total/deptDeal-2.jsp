...
<html xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	...
	<body>
 		<div id="man_zone">
			...
			<div class="fengge"></div>
            <div id="bt">     <a href="totalDeptExcel.action?startDate=${startDate}&endDate=${endDate}" target="_blank"><img src="<s:text name='sundyn.total.pic.excel'/>" /></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="totalDeptPrint.action?startDate=${startDate}&endDate=${endDate}" target="_blank"><img src="<s:text name='sundyn.total.pic.print'/>" /></a></div>

 		...
 		<div id="man_zone">
			...
			<div><img src="<s:text name='sundyn.total.pic.title' />" /></div>
 			<div style="width:732px;margin:0 auto;" >
				<table width="100%"  cellpadding="0" cellspacing="0" style="font-size:10px;" id="table123"  >
				  <tr>
...
<%--				    <td width="5%" height="47" align="center" valign="middle" bgcolor="fef9f3"  class="px13_1">${key.name}</td>--%>
           ...
           <s:if test="list.size==0"><a href="javascript:noData('this');"></s:if><s:else> <a href="totalDeptExcel.action?startDate=${startDate}&endDate=${endDate}" target="_blank"></s:else>
            ...
            <select name="type" id="type">
				...
				-->			
            <a href="duibiAction.action?startDate=${startDate}&endDate=${endDate}" target="_self">
            <img src="<s:text name='sundyn.total.jigou.duibi'/>" /></a></br>

	...
	<body>
		<div id="man_zone">
			<div class="sundyn_main">
				...
				<div class="sundyn_row">
					 <a href="totalPersonExcel.action?startDate=${startDate}&endDate=${endDate}&deptId=${deptId}">导出excel</a>
					 <a href="totalPersonPrint.action?startDate=${startDate}&endDate=${endDate}&deptId=${deptId}" target="_blank">打印</a>
				</div>
				<div class="sundyn_row">
				    ${pager.pageTextCn }
				</div>

...
<div class="layui-form">
    ...
    <div class="layui-select-cus layui-inline">
        <label class="layui-form-label" style="width:90px;">代理人识别号：</label>
        <div class="layui-form-mid layui-word-aux">
        </div>
        <input type="text" class="scinput" id="cardid" name="cardid" value="<%=request.getParameter("cardid")==null?"":request.getParameter("cardid")%>" />
    </div>
    <div class="layui-inline">
        <div class="layui-input-inline">
            <div style="float:left; height:25px;background:url('<s:text
                    name='sundyn.total.pic.query'/>') center no-repeat;margin-left:10px;" onclick="totalProxyBizDeal()">
    ...
    <div style="width:100%;margin:0 auto;">
        <table width="100%" cellpadding="0" cellspacing="0" class="tablelist" id="table123">
            <tr>
                ...
                <td rowspan="2" align="center" valign="middle"
                    background="images/03_02_07.jpg" class="px13_1">业务编码 / 业务名称</td>

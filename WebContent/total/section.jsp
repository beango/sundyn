...
#year,#month {
	...
	<body>
		...
		<div id="man_zone">
			...
			<div class="title360"> <h3><s:text name='left.menu.total5'/></h3></div>
				...
				<form id="form1" name="form1" method="post" action="">
				     <table width="75%" height="150" border="0" cellpadding="0" cellspacing="0" style="border-color:#FFFFFF;">
						  <tr>
						    ...
						    <td align="left" style="border-color:#FFFFFF;"><input type="text" id="startDate" <s:text name="sundyn.language.calendar.setDay"/> class="input_comm" /></td>
						  </tr>
						  <tr>
						    <td align="right" style="border-color:#FFFFFF;"> <s:text name='sundyn.total.endDate'/> </td>
						    <td align="left" style="border-color:#FFFFFF;"><input type="text" id="endDate" <s:text name="sundyn.language.calendar.setDay"/> class="input_comm"/></td>
						  </tr>
						  <tr>
						    <td align="right" style="border-color:#FFFFFF;">&nbsp;</td>
						    <td align="left" valign="bottom" style="border-color:#FFFFFF;"><img src="<s:text name='sundyn.total.pic.query'/>"   width="80" height="25"  onclick="totalSectionDeal()" style="cursor: pointer;" /></td>
						  </tr>
					</table>
			    </form>
			</div>

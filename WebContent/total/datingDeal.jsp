			...
			<div><img src="<s:text name='sundyn.total.pic.title' />" /></div>
 			<div style="width:732px;margin:0 auto;">
				<table width="100%"  cellpadding="0" cellspacing="0"  >
				  <tr>
				    <td width="8%" rowspan="2" align="center" valign="middle" background="images/03_02_07.jpg" class="px13_1"><s:text name="sundyn.column.datingName"/></td>
...
<%--				    <td width="5%" height="47" align="center" valign="middle" bgcolor="fef9f3"  class="px13_1">${key.name}</td>--%>
			...
			<div class="fengge"></div>
            <div><s:if test="list.size==0"><a href="javascript:noData('this');"></s:if><s:else><a href="totalDatingExcel.action?startDate=${startDate}&endDate=${endDate}" target="_blank"></s:else>
            <img src="<s:text name='sundyn.total.pic.excel'/>" /></a>&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="totalDatingPrint.action?startDate=${startDate}&endDate=${endDate}" target="_blank">
            <img src="<s:text name='sundyn.total.pic.print'/>" /></a>&nbsp;&nbsp;&nbsp;&nbsp;
            <!-- 大厅工作量对比 -->
             <a href="daTingDuiBiAction.action?startDate=${startDate}&endDate=${endDate}" target="_self">

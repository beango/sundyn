				...
				<tr>
					<td align="left" style="border-color: #FFFFFF; width: 100%;">
						...
						<div style="float: left;margin-left:20px;">
							...
							<s:else>
								<a
									href="totalDatingExcel.action?startDate=${startDate}&endDate=${endDate}"
									target="_blank">
							</s:else>
							<img src="<s:text name='sundyn.total.pic.excel'/>" /></a>&nbsp;&nbsp;&nbsp;&nbsp;
							<a
								href="totalDatingPrint.action?startDate=${startDate}&endDate=${endDate}"
								target="_blank"> <img

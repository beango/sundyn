...
<div class="layui-form">
    ...
    <div class="layui-inline">
        <div class="layui-input-inline">
            <div style="float: left; height: 25px;" onclick="totalDatingDeal(false)">
            ...
            <div style="float: left;margin-left:20px;">
                <s:if test="list.size==0">
                    ...
                    <s:else>
                    <a href="#" onclick="totalDatingDeal(true, '<%=request.getParameter("sort")%>')">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" class="tablelist" id="table123">
        <tr>
            ...
            <td rowspan="2" align="center" valign="middle"
                background="images/03_02_07.jpg" class="px13_1" sort="ticketcount">取号量<img src="../images/nor.png" /></td>
        ...
        <c:forEach items="${list}" var="total" varStatus="status">
            <tr>
                ...
                <td align="center" valign="middle">${total.datingname}</td>
                ...
                <td align="center" valign="middle">${total.pausetime.replace("0天00时00分","").replace("0天00时","").replace("0天","")}</td>
            ...
            <tr>
                <td colspan="7" align="center" valign="middle"
                    background="images/03_05_11.jpg" class="px12"><s:text
                        name="sundyn.total.toatlInfo.dating"/></td>
            </tr>

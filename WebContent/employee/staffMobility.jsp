...
#year,#month {
	...
	<body>
		...
		<div id="man_zone">
			...
			<div class="title360"> <h3>人员调动查询</h3></div>
			<div style="width:358px; height:172px; padding-top:20px;" class="kuang">
				<form id="form1" name="form1" method="post" action="staffMobilityDetail">
...
<%--						    </td>--%>
						  ...
						  <tr>
						    ...
						    <td align="left" valign="bottom" style="border-color:#FFFFFF;"><img src="<s:text name='sundyn.total.pic.query'/>"   width="80" height="25" onclick="javascript:form.submit();" style="cursor: pointer;" /></td>
						  </tr>
					</table>
		       </form>
			</div>

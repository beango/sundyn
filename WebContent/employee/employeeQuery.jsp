 	...
 	<table width="100%" border="0" cellspacing="1" cellpadding="0" style="border-top: 1px solid #bdd9ee;">
		      ...
		      <c:forEach items="${pager.pageList}" var="employee">
			      <tr>
			        ...
			        <td align="center" bgcolor="#FFFFFF" class="td1"><a href="javascript:employeeEditDialog(${employee.Id})"><s:text name="sundyn.modify"/></a> <s:text name="sundyn.separator"/>  <a href="javascript:employeeDel(${employee.Id})"><s:text name="sundyn.del"/></a><s:text name="sundyn.separator"/> <a href="javascript:employeeOut(${employee.Id})"><s:text name="sundyn.employee.out"/></a><s:text name="sundyn.separator"/> <a href="javascript:employeeReset(${employee.Id})"><s:text name="sundyn.employee.resetPassword"/></a></td>
			      </tr>
		     </c:forEach>
    </table> 

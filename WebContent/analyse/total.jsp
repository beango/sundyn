...
<%--		<script type="text/javascript" src="js/calendar_<s:text name='sundyn.language.calendar' />.js"></script>--%>
		...
		<div id="man_zone">
           ...
           <div class="center_05">
  	       <div class="title640"><h3> <s:text name="sundyn.analyse.title1" />   </h3> </div>
		   <div class="center_05_center kuang">
 			       <table width="80%" height="93" border="0" cellpadding="0" cellspacing="0" style="border-color:#FFFFFF; margin-top:10px;">
			         <tr>
			           ...
			           <td style="border-color:#FFFFFF;" width="31%" align="center"><img src="<s:text name='sundyn.analyse.pic.week' />"   onclick="analyseTotalAjaxDay(7)" style="cursor: pointer;" /></td>
			           <td style="border-color:#FFFFFF;" width="26%"><img src="<s:text name='sundyn.analyse.pic.15' />"    onclick="analyseTotalAjaxDay(15)" style="cursor: pointer;" /></td>
			           <td style="border-color:#FFFFFF;" width="31%" align="center"><img src="<s:text name='sundyn.analyse.pic.month' />"    onclick="analyseTotalAjaxDay(30)" style="cursor: pointer;" /></td>
			         </tr>
			         <tr>
			         ...
			         <tr>
			           ...
			           <td style="border-color:#FFFFFF;" align="center"><s:text name='sundyn.analyse.by' />
						   <select name="type" id="type">
								...
								<!--
								<option value="jidu">
									<s:text name='sundyn.analyse.jidu' />
								</option>
								-->
								<option value="year">
			           ...
			           <td style="border-color:#FFFFFF;" align="left"><img src="<s:text name='sundyn.analyse.pic.dataAnalyse' />" width="94" height="25" onclick="analyseTotalAjax()" style="cursor: pointer;" /></td>

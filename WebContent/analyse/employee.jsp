...
<%--		<script type="text/javascript" src="js/calendar_<s:text name='sundyn.language.calendar' />.js"></script>--%>
		...
		<div class="center_05">
             <div class="title640"><h3><s:text name="sundyn.analyse.title6" /></h3></div>
			 ...
			 <form id="form1" name="form1" method="post" action="">
		       <table width="90%" height="85" border="0" cellpadding="0" cellspacing="0" style="border-color:#FFFFFF; margin-top:19px;">
		            <tr>
		              <td style="border-color:#FFFFFF;" width="20%" align="right"><s:text name="sundyn.query.selectEmployee" /></td>
		              <td colspan="6" align="left" style="border-color:#FFFFFF;">
	                 	<input type="hidden" name="id" id="id" />
						<input type="text" name="keyword" id="keyword" class="input_comm" />
						<img class="hand" onclick="queryEmployee()" src="<s:text name='sundyn.pic.query' />"/>
		              </td>
		            </tr>
		            <tr>
		              <td style="border-color:#FFFFFF;" width="20%" height="26" align="right"><s:text name='sundyn.total.startDate'/></td>
		              <td style="border-color:#FFFFFF;" colspan="3"><input type="text" id="startDate" class="input_comm" <s:text name="sundyn.language.calendar.setDay"/> onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" /></td>
		              <td width="18%" align="right" style="border-color:#FFFFFF;"><s:text name='sundyn.total.endDate'/></td>
		              <td style="border-color:#FFFFFF;" colspan="2"><input type="text" id="endDate"   class="input_comm" <s:text name="sundyn.language.calendar.setDay"/> onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" /></td>
		            </tr>
		            <tr>
		              ...
		              <td style="border-color:#FFFFFF;"><img src="<s:text name="sundyn.analyse.businessNumAnalyse" />" onclick="analyseEmployeeAjax()" style="cursor: pointer;" /></td>
		              <td width="20%" align="center" style="border-color:#FFFFFF;"><img src="<s:text name="sundyn.analyse.contentNumAnalyse" />" onclick="analyseEmployeeContentAjax()" style="cursor: pointer;"   /></td>
		              <td width="23%" align="right" style="border-color:#FFFFFF;"><img src="<s:text name="sundyn.analyse.contentDegreeAnalyse" />"  onclick="analyseEmployeeContentRateAjax()" style="cursor: pointer;" /></td>
		            </tr>
		          </table>
		       </form>

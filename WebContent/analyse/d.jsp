...
#year,#month {
	...
	<body>
		...
		<div id="man_zone">
           ...
           <div class="center_05">
  	       <div class="title640"><h3><s:text name="sundyn.analyse.title4" /></h3> </div>
		   <div class="center_05_center kuang">
 			       <table width="80%" height="93" border="0" cellpadding="0" cellspacing="0" style="border-color:#FFFFFF; margin-top:10px;">
			         <tr>
			           ...
			           <td style="border-color:#FFFFFF;" width="31%" align="center"><img src="<s:text name='sundyn.analyse.pic.week' />" width="103" height="25" onclick="analyseContentDAjaxDay(7)" style="cursor: pointer;" /></td>
			           <td style="border-color:#FFFFFF;" width="26%"><img src="<s:text name='sundyn.analyse.pic.15' />" width="129" height="25"  onclick="analyseContentDAjaxDay(15)" style="cursor: pointer;" /></td>
			           <td style="border-color:#FFFFFF;" width="31%" align="center"><img src="<s:text name='sundyn.analyse.pic.month' />" width="103" height="25"  onclick="analyseContentDAjaxDay(30)" style="cursor: pointer;" /></td>
			         </tr>
			         <tr>
			           <td style="border-color:#FFFFFF;" align="right"><s:text name='sundyn.total.startDate'/></td>
			           <td style="border-color:#FFFFFF;"><input type="text" id="startDate" class="input_comm" <s:text name="sundyn.language.calendar.setDay"/> /></td>
			           <td style="border-color:#FFFFFF;" align="right"><s:text name='sundyn.total.endDate'/></td>
			           <td style="border-color:#FFFFFF;"><input type="text" id="endDate"   class="input_comm" <s:text name="sundyn.language.calendar.setDay"/> /></td>
			         </tr>
			         <tr>
			           ...
			           <td style="border-color:#FFFFFF;" align="left"><img src="<s:text name='sundyn.analyse.pic.dataAnalyse' />" width="94" height="25" onclick="analyseContentDAjax()" style="cursor: pointer;" /></td>

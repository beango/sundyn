...
<%--		<script type="text/javascript" src="js/calendar_<s:text name='sundyn.language.calendar' />.js"></script>--%>
		...
		<div class="center_05">
             <div class="title640"><h3><s:text name="sundyn.analyse.title5" /></h3></div>
			 ...
			 <form id="form1" name="form1" method="post" action="">
		       <table width="90%" height="85" border="0" cellpadding="0" cellspacing="0" style="border-color:#FFFFFF; margin-top:19px;">
		            ...
		            <tr>
		              ...
		              <td style="border-color:#FFFFFF;"><img src="<s:text name="sundyn.analyse.businessNumAnalyse" />"   onclick="analyseDeptAjax()" style="cursor: pointer;" /></td>
		              <td width="20%" align="center" style="border-color:#FFFFFF;"><img src="<s:text name="sundyn.analyse.contentNumAnalyse" />" onclick="analyseDeptContentAjax()" style="cursor: pointer;"  /></td>
		              <td width="23%" align="right" style="border-color:#FFFFFF;"><img src="<s:text name="sundyn.analyse.contentDegreeAnalyse" />"    onclick="analyseDeptContentRateAjax()" style="cursor: pointer;" /></td>
 		            </tr>
		          </table>
		       </form>

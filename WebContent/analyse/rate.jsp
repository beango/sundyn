...
<script language="javascript" type="text/javascript" src="My97DatePicker/WdatePicker.js"></script>
		<div id="man_zone">
           ...
           <div class="center_05">
  	       <div class="title640"><h3> <s:text name="sundyn.analyse.title3" />  </h3></div>
				 ...
				 <form id="form1" name="form1" method="post" action="">
			       <table width="80%" height="93" border="0" cellpadding="0" cellspacing="0" style="border-color:#FFFFFF; margin-top:10px;">
			         <tr>
			           ...
			           <td style="border-color:#FFFFFF;" width="31%" align="center"><img src="<s:text name='sundyn.analyse.pic.week' />"  onclick="analyseContentRateAjaxDay(7)" style="cursor: pointer;" /></td>
			           <td style="border-color:#FFFFFF;" width="26%"><img src="<s:text name='sundyn.analyse.pic.15' />"    onclick="analyseContentRateAjaxDay(15)" style="cursor: pointer;" /></td>
			           <td style="border-color:#FFFFFF;" width="31%" align="center"><img src="<s:text name='sundyn.analyse.pic.month' />"   onclick="analyseContentRateAjaxDay(30)" style="cursor: pointer;" /></td>
			         </tr>
			         <tr>
			         ...
			         <tr>
			           ...
			           <td style="border-color:#FFFFFF;" align="left"><img src="<s:text name='sundyn.analyse.pic.dataAnalyse' />" width="94" height="25" onclick="analyseContentRateAjax()"  style="cursor: pointer;" /></td>

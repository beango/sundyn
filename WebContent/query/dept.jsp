...
<%--	<script type="text/javascript" src="js/calendar_<s:text name='sundyn.language.calendar' />.js"></script>--%>
		...
		<s:else>
 		...
 		<div class="fengge">&nbsp;</div>
 			 <div class="title360"><h3><s:text name='sundyn.query.title1'/></h3></div>
			 <div class="content360 kuang">
					     <table width="100%" height="151" border="0" cellpadding="0" cellspacing="0" style="border-color:#FFFFFF;">
							  <tr>
							    <td width="28%" align="right" style="border-color:#FFFFFF;"><s:text name='sundyn.query.selectDept'/></td>
							  ...
							  <tr>
 							  ...
 							  <tr>
							    ...
							    <td align="left" valign="bottom" style="border-color:#FFFFFF;"><img src="<s:text name='sundyn.total.pic.query'/>"  width="80" height="25" class="hand" onclick="querydept()" /></td>
							  </tr>
						</table>
			</div>
 		</div>

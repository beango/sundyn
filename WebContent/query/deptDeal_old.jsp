			...
			<div class="fengge">&nbsp;</div>
				<table width="98%" class="t" >
					<tr>
						...
						<!-- 录像 -->
						<td width="8%" class="tdtitle" align="center" valign="middle" background="images/03_02_07.jpg" class="px13_1">录像</td>
					...
					<c:forEach items="${pager.pageList}" var="query">
						<tr>
 						...
 						<!--	 <c:if test="${empty query.videofile}">
 							 ...
 							 <c:if test="${!empty query.videofile}">
 							   <a href="query/videoPlay.jsp?videoName=${query.videofile}" target="_blank"><img src="images/lx.jpg"/></a>
 							 </c:if>
							 -->
							 <c:choose>

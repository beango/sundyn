			...
			<div class="center_04">
				 ...
				 <div class="center_04_right">
					  ...
					  <form id="form1" name="form1" method="post" action="">
					       <table align="center" width="80%" height="97" border="0" cellpadding="0" cellspacing="0" style="border-color:#FFFFFF;">
							  <tr>
							  ...
							  <tr>
							    ...
							    <td colspan="2" align="left" style="border-color:#FFFFFF;">
							      <input type="text" id="amUp" value="08:30" />
							    </td>
							  </tr>
							  <tr>
							  ...
							  <tr>
							    ...
							    <td colspan="2" align="left" style="border-color:#FFFFFF;">
							      <input type="text" id="pmDown" value="17:30" />
							    </td>
							  </tr>
							   <tr>
					  ...
					  <div class="center_04_right_03">
					    <table width="60%" border="0" cellspacing="0" cellpadding="0" style="border-color:#d6ecf8">
			              <tr>
			                <td width="40%" align="right" style="border-color:#d6ecf8" colspan="3"><img src="images/auto_create.gif" width="81" height="25" style="cursor: pointer;" onclick="queryZhDeal()" class="hand" /></td>
			              </tr>
			            </table>
			   		 </div>
				 </div>

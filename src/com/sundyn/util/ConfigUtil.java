...
public class ConfigUtil {
     ...
     * 服务号相关信息
     */
    public final static String APPID = "wx3386db73536a091d";//服务号的应用号
     ...
     */
    //微信支付统一接口(POST)
    public final static String UNIFIED_ORDER_URL = "https://api.mch.weixin.qq.com/sandboxnew/pay/unifiedorder";
    //微信退款接口(POST)
